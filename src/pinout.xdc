...
# alu_sel in JA[1, 2, 3, 4]
set_property -dict { PACKAGE_PIN Y18    IOSTANDARD LVCMOS33  } [get_ports { alu_sel[0] }];
set_property -dict { PACKAGE_PIN Y19    IOSTANDARD LVCMOS33  } [get_ports { alu_sel[1] }];
set_property -dict { PACKAGE_PIN Y16    IOSTANDARD LVCMOS33  } [get_ports { alu_sel[2] }];
set_property -dict { PACKAGE_PIN Y17    IOSTANDARD LVCMOS33  } [get_ports { alu_sel[3] }];

# input a in JA[7, 8, 9, 10]
set_property -dict { PACKAGE_PIN U18    IOSTANDARD LVCMOS33  } [get_ports { a[0] }];
set_property -dict { PACKAGE_PIN U19    IOSTANDARD LVCMOS33  } [get_ports { a[1] }];
set_property -dict { PACKAGE_PIN W18    IOSTANDARD LVCMOS33  } [get_ports { a[2] }];
set_property -dict { PACKAGE_PIN W19    IOSTANDARD LVCMOS33  } [get_ports { a[3] }];
